public class BinarySearchRunner
{
    public static void main(String[] args)
    {
        ...
        idx = BinarySearch.iterativeNonRecursiveBinarySearch(arr1, 12);
        idx2 = BinarySearch.recursiveBinarySearch(arr1, 0, 14, 12);
        System.out.println(idx);
        System.out.println(idx2);
        System.out.println("---------");

        idx = BinarySearch.iterativeNonRecursiveBinarySearch(arr1, 55);
        idx2 = BinarySearch.recursiveBinarySearch(arr1, 0, 14, 55);
        System.out.println(idx);
        System.out.println(idx2);
        System.out.println("---------");
